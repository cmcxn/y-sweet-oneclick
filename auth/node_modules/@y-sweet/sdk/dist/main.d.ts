...
type Authorization = 'full' | 'read-only';
type AuthDocRequest = {
...
declare class DocConnection {
     ...
     * @returns
     */
    getAsUpdate(): Promise<Uint8Array>;
    /**
     ...
     * @param update
     */
    updateDoc(update: Uint8Array): Promise<void>;
}
...
declare class DocumentManager {
     ...
     */
    getClientToken(docId: string | DocCreationResult, authDocRequest?: AuthDocRequest): Promise<ClientToken>;
    /**
     ...
     * @returns A {@link ClientToken} object containing the URL and token needed to connect to the document.
     */
    getOrCreateDocAndToken(docId?: string, authDocRequest?: AuthDocRequest): Promise<ClientToken>;
    /**
     * Returns an entire document, represented as a Yjs update byte string.
     *
    ...
    getDocConnection(docId: string | DocCreationResult, authDocRequest?: AuthDocRequest): Promise<DocConnection>;
    /**
     ...
     * @returns A {@link DocCreationResult} object containing the ID of the created document.
     */
    createDocWithContent(update: Uint8Array): Promise<DocCreationResult>;
}
/**
 ...
 * @returns A {@link ClientToken} object containing the URL and token needed to connect to the document.
 */
declare function getOrCreateDocAndToken(connectionString: string, docId?: string, authDocRequest?: AuthDocRequest): Promise<ClientToken>;
/**
 ...
 * @returns A {@link ClientToken} object containing the URL and token needed to connect to the document.
 */
declare function getClientToken(connectionString: string, docId: string | DocCreationResult, authDocRequest?: AuthDocRequest): Promise<ClientToken>;
/**
...
export { CheckStoreResult, ClientToken, DocConnection, DocCreationResult, DocumentManager, YSweetError, YSweetErrorPayload, createDoc, decodeClientToken, encodeClientToken, getClientToken, getOrCreateDocAndToken };
